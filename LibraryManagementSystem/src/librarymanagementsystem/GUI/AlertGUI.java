...
public class AlertGUI extends javax.swing.JFrame{
    ...
    public AlertGUI(String title, String alert, String choice_1, String choice_2) {
        initComponents(title, alert, choice_1, choice_2);
        setSize(400, 260);
    ...
    private void initComponents(String title, String alert, String choice_1, String choice_2) {
        ...
        icon_main.setIcon(new javax.swing.ImageIcon(getClass().getResource("../images/alert_80_80.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AlertGUI("Thông Báo", "Bạn có thông báo.", "Xem thông báo", "Thoát").setVisible(true);
            }
        });
    }
