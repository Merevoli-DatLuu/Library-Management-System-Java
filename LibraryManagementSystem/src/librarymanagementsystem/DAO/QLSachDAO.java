...
public class QLSachDAO {
    ...
    public ArrayList<QLSachDTO> readDB(){
        DBSach = new DBConnection();
        ArrayList<QLSachDTO> arrSach = new ArrayList<>();
    ...
    public Boolean del(String maSach){
        DBSach = new DBConnection();
        Boolean check = DBSach.SQLUpdate("DELETE FROM Sach WHERE Sach.maSach = '" + maSach + "'");
        DBSach.closeConnection();
        return check;
    }
    ...
    public Boolean mod(QLSachDTO sach){
        DBSach = new DBConnection();
        Boolean check = DBSach.SQLUpdate("Update Sach Set "
