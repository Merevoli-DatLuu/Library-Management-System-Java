...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th5 20, 2020 lúc 04:53 PM
...
('AD000001', '123456datluu', NULL, NULL);
...
--
-- Cấu trúc bảng cho bảng `lydophat`
--
...
--
-- Đang đổ dữ liệu cho bảng `lydophat`
--

INSERT INTO `lydophat` (`maLDPhat`, `tenLDPhat`, `mucDo`) VALUES
('LDP000001', 'Mất sách', 0),
('LDP000002', 'Hư sách', 0),
('LDP000003', 'Trả sách trễ hạn', 0);
...
INSERT INTO `phieumuon` (`maMuonSach`, `maThe`, `IDSach`, `ngayMuon`, `thoiGianMuon`, `ngayTra`) VALUES
('M000001', 'T000001', 'IDS000001', '2020-01-10', 14, '2020-01-20'),
('M000002', 'T000002', 'IDS000004', '2020-01-25', 14, '2020-01-29'),
('M000003', 'T000003', 'IDS000008', '2020-02-04', 14, '2020-02-20'),
('M000004', 'T000003', 'IDS000012', '2020-02-12', 14, '2020-02-23'),
('M000005', 'T000004', 'IDS000013', '2020-02-05', 28, '2020-03-05'),
('M000006', 'T000005', 'IDS000019', '2020-02-05', 28, '2020-03-05'),
('M000007', 'T000005', 'IDS000023', '2020-02-03', 14, '2020-02-08'),
('M000008', 'T000006', 'IDS000030', '2020-02-08', 14, '2020-02-15'),
('M000009', 'T000006', 'IDS000038', '2020-02-08', 14, '2020-02-15'),
('M000010', 'T000007', 'IDS000053', '2020-02-28', 56, '2020-04-28'),
('M000011', 'T000008', 'IDS000026', '2020-03-14', 28, '2020-04-08'),
('M000012', 'T000009', 'IDS000070', '2020-03-20', 56, '2020-04-28'),
('M000013', 'T000010', 'IDS000064', '2020-04-03', 28, '2020-04-26'),
('M000014', 'T000011', 'IDS000067', '2020-04-08', 14, '2020-04-25'),
('M000015', 'T000012', 'IDS000076', '2020-04-16', 28, '2020-05-12'),
('M000016', 'T000013', 'IDS000058', '2020-04-18', 28, '2020-05-06'),
('M000017', 'T000014', 'IDS000045', '2020-04-21', 14, '2020-04-25'),
('M000018', 'T000015', 'IDS000078', '2020-05-02', 14, '2020-05-06'),
('M000019', 'T000015', 'IDS000063', '2020-05-02', 14, '2020-05-19'),
('M000020', 'T000016', 'IDS000029', '2020-05-09', 14, '2020-05-21'),
('M000021', 'T000017', 'IDS000047', '2020-05-11', 28, '2020-06-12'),
('M000022', 'T000018', 'IDS000056', '2020-05-21', 56, '2020-06-25'),
('M000023', 'T000019', 'IDS000015', '2020-06-02', 14, '2020-06-06'),
('M000024', 'T000020', 'IDS000025', '2020-06-07', 14, '2020-06-15');
...
CREATE TABLE `phieuphat` (
  ...
  `maMuonSach` varchar(7) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `phieuphat` (`maPhieuPhat`, `maMuonSach`, `tienPhat`, `maLDPhat`) VALUES
...
ALTER TABLE `chitietphieumuon`
  ...
  ADD CONSTRAINT `FK_MaPhieuMuon_ChiTietPhieuMuon` FOREIGN KEY (`maPhieuMuon`) REFERENCES `phieumuon` (`maMuonSach`);
...
--
ALTER TABLE `phieuphat`
  ADD CONSTRAINT `FK_MaMuonSach` FOREIGN KEY (`maMuonSach`) REFERENCES `phieumuon` (`maMuonSach`),
